...
Set-OctopusVariable -octopusURL $OctopusParameters["Octopus.Web.BaseUrl"] -octopusAPIKey $OctopusParameters["ApiKey"] -projectName $OctopusParameters["Octopus.Project.Name"] -environment $OctopusParameters["Octopus.Environment.Name"] -varName "ConenctionString" -varValue $connectionString